...
| `event_type` | [`str (Cash Drawer Event Type)`]($m/CashDrawerEventType) | Optional | The types of events on a CashDrawerShift.<br>Each event type represents an employee action on the actual cash drawer<br>represented by a CashDrawerShift. |
