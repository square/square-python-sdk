...
| `modifier_overrides` | [`List of Catalog Modifier Override`]($m/CatalogModifierOverride) | Optional | A set of `CatalogModifierOverride` objects that override whether a given `CatalogModifier` is enabled by default. |
