...
| `state` | [`str (V1 Order State)`]($m/V1OrderState) | Optional | - |
| `shipping_address` | [`Address`](/doc/models/address.md) | Optional | Represents a physical address. |
| `subtotal_money` | [`V1 Money`]($m/V1Money) | Optional | - |
| `total_shipping_money` | [`V1 Money`]($m/V1Money) | Optional | - |
| `total_tax_money` | [`V1 Money`]($m/V1Money) | Optional | - |
| `total_price_money` | [`V1 Money`]($m/V1Money) | Optional | - |
| `total_discount_money` | [`V1 Money`]($m/V1Money) | Optional | - |
