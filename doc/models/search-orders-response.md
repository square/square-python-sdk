...
|  --- | --- | --- | --- |
| `order_entries` | [`List of Order Entry`]($m/OrderEntry) | Optional | List of [OrderEntries](#type-orderentry) that fit the query<br>conditions. Populated only if `return_entries` was set to `true` in the request. |
